...
const wheelCar = () => {
    imgItem.value = document.querySelector('#whellItems img')
    switch (currentWheel) {
        case 0:
            imgItem.value.setAttribute("src", "/src/assets/1.png");
            break
        case 1:
            imgItem.value.setAttribute("src", "/src/assets/2.png");
            break
        case 2:
            imgItem.value.setAttribute("src", "/src/assets/3.png");
            break
        case 3:
            imgItem.value.setAttribute("src", "/src/assets/4.png");
            break
        case 4:
            imgItem.value.setAttribute("src", "/src/assets/5.png");
            break
        case 5:
            imgItem.value.setAttribute("src", "/src/assets/7.png");
            break
        case 6:
            imgItem.value.setAttribute("src", "/src/assets/8.png");
            break
        case 7:
            imgItem.value.setAttribute("src", "/src/assets/9.png");
            break
        case 8:
            imgItem.value.setAttribute("src", "/src/assets/10.png");
            break
        case 9:
            imgItem.value.setAttribute("src", "/src/assets/11.png");
            break
    }
...
const wheelCarTwo = () => {
    imgItem.value = document.querySelector('#whellItemsTwo img')
    switch (currentWheel) {
        case 0:
            imgItem.value.setAttribute("src", "/src/assets/1.1.png");
            break
        case 1:
            imgItem.value.setAttribute("src", "/src/assets/2.1.png");
            break
        case 2:
            imgItem.value.setAttribute("src", "/src/assets/2.3.png");
            break
        case 3:
            imgItem.value.setAttribute("src", "/src/assets/2.4.png");
            break
        case 4:
            imgItem.value.setAttribute("src", "/src/assets/2.5.png");
            break
        case 5:
            imgItem.value.setAttribute("src", "/src/assets/2.6.png");
            break
        case 6:
            imgItem.value.setAttribute("src", "/src/assets/2.7.png");
            break
        case 7:
            imgItem.value.setAttribute("src", "/src/assets/2.8.png");
            break
        case 8:
            imgItem.value.setAttribute("src", "/src/assets/2.9.png");
            break
        case 9:
            imgItem.value.setAttribute("src", "/src/assets/10.1.png");
            break
    }
